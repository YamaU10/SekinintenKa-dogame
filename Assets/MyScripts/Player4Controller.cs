            ...
            if (GameActiveMode < 4)
                switch (GameActiveMode)
                {
                    case 0: //Select
                        ...
                        MyCards = GameObject.FindGameObjectsWithTag("4PCARDObj");
                    ...
                    case 2: //del
                        ...
                        for (int i = max - 1; i >= 0; --i)
                        {
                            if (DelCardFlag[i])
                            {
                                _list.RemoveAt(i);
                                Destroy(MyCards[i]);
                                CManager.P4CardCount -= 1;
                                CManager.P4DeathCard();
                            }
                        }
                    ...
                    switch (GameMode)
                    {
                        ...
                        case 3:
                            ...
                            else if (QCount == 3)
                            {
                                ...
                                {
                                    MyCards[RandomCard].transform.parent = CManager.p3Folder.transform;
                                    MyCards[RandomCard].GetComponent<CardText>().CardImage.GetComponent<Image>().enabled = false;
                                    MyCards[RandomCard].GetComponent<CardText>().Naiyou.text = "";
                                    MyCards[RandomCard].GetComponent<CardText>().Number1.text = "";
                                    MyCards[RandomCard].GetComponent<CardText>().Number2.text = "";
